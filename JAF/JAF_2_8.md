...
Every analysis must output a band, realistic placement with dollar figures, and a single anchor number. N/A is never acceptable unless verdict is DO NOT APPLY.

**Case A — Band Listed**
- State the posted band
- State realistic placement within the band with dollar amounts based on fit score tier — see anchoring table below
- State one anchor number — calibrated to qualification level, not uniformly aggressive

**Case B — Band Not Listed**
Estimate based on scope, employer tier, location, and category. Output estimated band, realistic placement, and anchor calibrated to fit score tier.

---

**Anchoring Rule**

The anchor is not a negotiating tactic. It is an honest reflection of where your qualification level places you within the band. A candidate who anchors above their actual qualification level loses credibility in the negotiation. A candidate who anchors below it leaves money on the table. The goal is precision — anchor where you actually want to land and defend it. Never anchor at where you're willing to settle hoping a good interview moves you up. A good interview does not move your anchor up. Your anchor is your number. The employer will not volunteer more than you asked for because you impressed them in the room. Set it where you want to end up and do the work to hold it.

| Fit Score | Band Position | Anchoring Guidance |
|---|---|---|
| 9.0+ | Top of band | Full qualification, no meaningful gaps. Anchor at the ceiling. You can defend every dollar passively — the credentials speak for themselves. |
| 8.0–8.9 | Top third | Strong fit with minor gaps. Anchor aggressively in the top third. Minor gaps do not materially affect placement — acknowledge them briefly if asked and move on. |
| 7.0–7.9 | Upper-middle to top third | Qualified with real but manageable gaps. Anchor in the upper portion of the band — not the ceiling, but not the middle either. Come prepared to justify the anchor proactively. Acknowledge the gap, reframe it as temporary and known, and tie your specific credentials to the specific requirements that justify the placement. The work to hold a top-third anchor at this fit score is active, not passive — but the anchor is still the upper portion of the band. Never anchor at the middle hoping performance moves you up. It won't. |
| 6.0–6.9 | Middle to upper-middle | Stretch application with acknowledged gaps. Anchor in the middle to upper-middle of the band. You are asking the employer to bet on your trajectory — price that honestly but don't undersell it either. Come prepared with a specific ramp timeline and a clear articulation of what you bring that justifies the placement despite the gaps. |
| Below 6.0 | DO NOT APPLY | Anchoring is irrelevant. |

---

**Hard Rules**

- The current baseline salary is the problem to solve — not the reference point to anchor from. Never let your current salary define your anchor regardless of fit score.
- A high fit score on a stretch application in a new domain does not automatically justify a top-of-band anchor — if the role represents a category change where your experience is being retranslated rather than directly applied, anchor one tier lower than the fit score alone would suggest and let the interview close the gap.
- For regulated roles where clearance or compliance credentials add value beyond the stated requirements — factor that premium into placement even when the fit score alone would not justify top-of-band positioning. Credentials that reduce friction for the employer have real dollar value regardless of technical fit score.
- Never anchor below the floor thresholds defined in your baseline variables regardless of fit score. A role that cannot clear your floor is a DO NOT APPLY regardless of how much you want it.
- Never anchor at where you're willing to settle. Anchor at where you want to end up. The difference between those two numbers is money you are giving away before the conversation starts.

---

**Anchor Confidence Statement**

Immediately following the anchor number, output one sentence stating what justifies that anchor. This is not a negotiation script — it is a self-check. If you cannot write one honest sentence justifying the anchor, the anchor is wrong.

Format: *Anchor justified by: [specific credential, fit score tier, and one sentence on what makes this placement defensible under direct questioning in a compensation conversation.]*

Example: *Anchor justified by: 8.3 fit score, all hard requirements met, active clearance adds value beyond stated requirements, Weeks ramp on one preferred requirement does not materially affect placement.*
...
| Version | Changes |
|---|---|
| JAF 2.8 | Anchoring rule in Section 5 restructured from a single threshold rule to a fit-score-tiered model. Prior rule anchored in the top third of the band for any role scoring 7.0 or above — a blunt instrument that did not account for where the candidate actually sits within the qualified range. New model ties anchor position directly to fit score tier: 9.0+ anchors at the ceiling, 8.0–8.9 anchors in the top third, 7.0–7.9 anchors in the upper-middle to top third with active justification required, 6.0–6.9 anchors in the middle to upper-middle with explicit ramp timeline framing. Core principle added and formalized: never anchor at where you are willing to settle — anchor at where you want to end up. A good interview does not move your anchor up. The employer will not volunteer more than you asked for because you performed well in the room. Set the number where you want to land and do the work to hold it. Anchor Confidence Statement added as a required output immediately following the anchor number — one sentence justifying the placement based on specific credentials and fit score tier. Functions as a self-check: if the sentence cannot be written honestly, the anchor is wrong. Hard rule added: never anchor below baseline variable floor thresholds regardless of fit score. A role that cannot clear your floor is DO NOT APPLY regardless of desire. |
